    ...
    <main id="conteudo">
      ...
      <section id="recursos" class="chapter platform-capabilities">
        <div class="site-container platform-capabilities__layout">
          <div class="platform-capabilities__intro" data-platform-reveal>
          ...
          <div class="platform-capabilities__list">
            <article v-for="(item, index) in capabilities" :key="item.title" data-platform-reveal>
...
.platform-capabilities { align-items: flex-start; background: #f3f7f4; }.platform-capabilities__layout { display: grid; grid-template-columns: .75fr 1.25fr; gap: clamp(4rem, 8vw, 9rem); }.platform-capabilities__intro { position: sticky; top: 140px; }.platform-capabilities__list { border-top: 1px solid var(--line); }.platform-capabilities__list article { display: grid; min-height: 310px; padding: clamp(2rem, 4vw, 3.5rem) 0; align-content: center; border-bottom: 1px solid var(--line); }.platform-capabilities__list article > div { display: flex; align-items: center; justify-content: space-between; }.platform-capabilities__list article > div > span { display: grid; width: 48px; height: 48px; place-items: center; border-radius: 14px; background: var(--green-light); color: var(--green); }.platform-capabilities__list article > div > small { color: #9aa7a2; font-size: .65rem; font-weight: 800; }.platform-capabilities__list article > p { margin-top: 2rem; color: var(--green); font-size: .7rem; font-weight: 800; }.platform-capabilities__list h3 { margin-top: .5rem; font-size: clamp(2rem, 4vw, 4.5rem); letter-spacing: -.055em; }.platform-capabilities__list article > strong { max-width: 42rem; margin-top: 1.1rem; color: var(--muted); font-size: .95rem; font-weight: 500; line-height: 1.7; }
...
@media (max-width: 1080px) { .platform-hero__layout { grid-template-columns: 1fr; padding-block: 3rem; }.platform-hero__content { max-width: 800px; }.platform-console { width: min(100%, 820px); margin-inline: auto; transform: none; }.platform-storefront__layout, .platform-scale__layout { grid-template-columns: 1fr; }.platform-section-copy { max-width: 780px; }.storefront-scene { width: min(100%, 820px); margin-inline: auto; }.platform-capabilities__layout { grid-template-columns: 1fr; }.platform-capabilities__intro { position: static; max-width: 800px; }.platform-capabilities__list { display: grid; grid-template-columns: 1fr 1fr; }.platform-capabilities__list article { padding: 2rem; border-right: 1px solid var(--line); }.platform-scale__image { order: 2; } }
