...
.operation-feature__text strong { display: block; font-size: var(--aux-title-size); font-weight: 750; }
...
.operation-editorial__image figcaption { position: absolute; z-index: 1; right: 2rem; bottom: 2rem; left: 2rem; display: flex; align-items: center; gap: .8rem; color: #f1f9f3; font-size: var(--description-size); font-weight: 650; line-height: 1.4; }
...
.integrations-hub__identity div { display: grid; gap: .12rem; }.integrations-hub__identity small { color: rgba(255,255,255,.46); font-size: .6rem; font-weight: 700; }.integrations-hub__identity strong { font-size: var(--aux-title-size); }
...
.migration-track article { position: relative; padding-right: clamp(1rem, 3vw, 3rem); }.migration-track article > span { position: relative; z-index: 1; display: grid; width: 50px; height: 50px; place-items: center; border: 1px solid #bfd0c7; border-radius: 50%; background: #f9fbfa; color: var(--green); font-size: .67rem; font-weight: 800; }.migration-track article > svg { margin-top: 2rem; color: var(--green); }.migration-track h3 { margin-top: 1rem; font-size: var(--aux-title-size); }.migration-track p { max-width: 15rem; margin-top: .65rem; color: var(--muted); font-size: var(--description-size); line-height: 1.6; }
