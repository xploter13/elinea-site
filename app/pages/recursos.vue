...
.integrations-band h2 { max-width: 52rem; margin-top: .9rem; font-size: clamp(2.3rem, 4.5vw, 4.8rem); line-height: .98; letter-spacing: -.03em; }.integrations-band > p { color: var(--muted); line-height: 1.7; }
