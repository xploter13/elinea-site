...
O ecossistema de recursos mantém a metáfora de módulos conectados, mas com hierarquia mais premium: o núcleo Elínea concentra a mensagem e os módulos aparecem em dois trilhos laterais ligados por linhas discretas. Para integrar a composição ao restante da home, o núcleo usa corpo branco e reserva o azul-marinho com petróleo para o cabeçalho, evitando um bloco escuro muito alto e dominante. Os módulos usam uma paleta secundária contida — verde, azul, âmbar e violeta — associada às categorias de recurso também por ícone e texto, nunca apenas por cor. Camadas, sombras suaves e uma malha técnica de baixo contraste completam a composição. No mobile, o núcleo vem primeiro e os módulos formam uma grade sem conexões decorativas.
