...
Abaixo do hero, alternar fundos para dar ritmo e separar os capítulos sem depender de ornamentos. A composição de cada seção pode mudar radicalmente quando o usuário fornecer uma referência explícita; nessas situações, preservar apenas os elementos que ele pedir. Na versão atual, o Ecossistema usa fundo branco e uma vitrine horizontal inspirada diretamente na diagramação de cases do WooCommerce.

Em 15 de setembro de 2026, o usuário aprovou uma malha fluida para o site inteiro: containers, espaçamentos, títulos, grids e cards devem usar a largura disponível continuamente com `clamp()`, `minmax()` e gutters responsivos. Breakpoints ficam reservados para mudanças reais de estrutura, como empilhamento no mobile; não usar saltos rígidos para cada tamanho intermediário e não permitir texto cortado ou overflow horizontal.
...
- A homepage do WooCommerce em português (`https://woocommerce.com/pt-br/`) passou a orientar a composição das seções em 15 de setembro de 2026: capítulos de grande escala, alternância clara entre alinhamentos, carrosséis editoriais com cartões amplos, painéis que atravessam mudanças de fundo, mosaicos assimétricos, fundos com contraste decidido, raios mais contidos e menos molduras concorrentes. Não copiar o roxo, o laranja, a marca, os números ou as provas sociais do Woo; traduzir essa gramática para o verde, o azul-marinho e o conteúdo verificável da Elínea.
...
A jornada da venda usa uma composição inspirada na referência visual enviada em 14 de setembro de 2026: título e ação no topo, seletor horizontal das quatro etapas e um painel amplo que combina benefício comercial com uma cena do produto. O card da jornada usa a superfície dark azul-marinho oficial, com os estados inativos nessa mesma base e o step ativo em branco; a barra de progresso usa o verde high-tech `#5cdda4`, com brilho discreto, e os ícones mantêm o verde principal. A etapa ativa é escolhida por clique ou toque; não há navegação customizada por setas/Home/End entre os steps. No mobile, o seletor passa para duas colunas e o painel empilha conteúdo e mockup. Manter a paleta da Elínea; o verde-limão da referência não faz parte da identidade aprovada.

O ecossistema de recursos segue, por instrução explícita do usuário em 15 de setembro de 2026, a arquitetura visual da seção de cases do WooCommerce: introdução ampla, abas horizontais e uma cena formada por três painéis grandes — texto editorial, demonstração visual do módulo e mensagem de impacto — com setas circulares abaixo. As abas trocam o conteúdo completo da cena. Preservar nessa seção a tipografia e os efeitos de texto da Elínea; os demais aspectos da composição anterior não precisam ser mantidos. No mobile, os três painéis empilham sem perder a ordem de leitura e as abas continuam roláveis horizontalmente.
...
- Alternar o tratamento tipográfico entre as seções abaixo do hero. Jornada, “Tecnologia sem peso” e Segmentos usam reveal vertical mascarado por linha; Ecossistema e Planos começam com o título inteiro em baixa opacidade e recuperam o contraste palavra por palavra conforme o scroll avança, sem pinning. Rótulos e textos de apoio usam uma entrada mais curta e suave. Não aplicar esses efeitos a cards, preços, botões, controles ou conteúdo dinâmico, e manter todo o texto imediatamente legível com movimento reduzido.
