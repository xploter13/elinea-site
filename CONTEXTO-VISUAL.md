...
O ecossistema de recursos mantém a metáfora de módulos conectados, mas com hierarquia mais premium: um núcleo Elínea profundo concentra a mensagem e os módulos aparecem em dois trilhos laterais ligados por linhas discretas. A seção permanece clara; o verde profundo fica restrito ao núcleo, com camadas, sombras suaves e uma malha técnica de baixo contraste. No mobile, o núcleo vem primeiro e os módulos formam uma grade sem conexões decorativas.
